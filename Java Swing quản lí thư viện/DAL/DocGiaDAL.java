...
//                pr.setString(13, the.getMaThe());
    ...
    public boolean SuaDocGia(DocGiaDTO dg, String ma){
        int n=0;
         String sqlupdate = "UPDATE DOCGIA SET TEN=?, GIOITINH=?, DIACHI=?, SDT=?, NGAYSINH=TO_DATE(?,'dd-MM-yyyy'), DOITUONG=?, LOP=?, Email=? WHERE MADOCGIA='" + ma + "'";
        try {
            ...
            update.setString(8, dg.getEmail());
